...
public class BookController {
	 ...
	 * @return List of books which have input value in author or title, together
	 *         with HTTP status.
	 */
	 ...
	 * @return returns whether category is saved or not in boolean value, together
	 *         with HTTP status.
	 */
	 ...
	 * @return List of books which are in chosen category, together with HTTP
	 *         status.
	 */
