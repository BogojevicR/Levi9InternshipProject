...
public class TestBookController {
	...
	public void saveShouldReturnSavedBook() throws Exception {
		...
		this.mockMvc
				.perform(MockMvcRequestBuilders.post("/api/book/save").contentType(MediaType.APPLICATION_JSON_UTF8)
	...
	public void getAllShouldReturnAllBooks() throws Exception {
		...
		this.mockMvc.perform(MockMvcRequestBuilders.get("/api/book/getAll"))
	...
	public void editBookShouldReturnTrue() throws Exception {
		...
		this.mockMvc.perform(MockMvcRequestBuilders.put("/api/book/edit").contentType(MediaType.APPLICATION_JSON_UTF8)
				.content(new Gson().toJson(edit))).andExpect(MockMvcResultMatchers.status().isOk());
	...
	public void editBookShouldThrowException() throws Exception {
		...
		this.mockMvc.perform(MockMvcRequestBuilders.put("/api/book/edit").contentType(MediaType.APPLICATION_JSON_UTF8)
				.content(new Gson().toJson(edit))).andExpect(MockMvcResultMatchers.status().isUnauthorized());
