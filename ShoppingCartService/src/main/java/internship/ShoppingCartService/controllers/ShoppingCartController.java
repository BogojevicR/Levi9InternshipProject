...
public class ShoppingCartController {
	 ...
	 * 
	 */
	@PutMapping(value = { "changeQuantity/{cartId}/{quantity}/{bookORItemId}",
			"changeQuantity/{quantity}/{bookORItemId}" })
	public boolean changeQuantity(@PathVariable Optional<Long> cartId, @PathVariable int quantity,
			@PathVariable Long bookORItemId) {
